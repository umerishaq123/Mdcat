...
class AllChaptersScreenForTeachersdesktop extends StatefulWidget {
  final Subject subject;
  const AllChaptersScreenForTeachersdesktop({super.key, required this.subject});

  @override
  State<AllChaptersScreenForTeachersdesktop> createState() => _AllChaptersScreenForTeachersdesktopState();
}

class _AllChaptersScreenForTeachersdesktopState extends State<AllChaptersScreenForTeachersdesktop> {
  String? filePath;
  @override
  void initState() {
    super.initState();
